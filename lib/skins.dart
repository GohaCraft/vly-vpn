...
class VlySkin {
  ...
  static const all = [
    ...
    VlySkin(
      id: VlySkinId.midnight, name: 'Midnight', emoji: '🌌',
    ...
    VlySkin(
      id: VlySkinId.ocean, name: 'Ocean', emoji: '🌊',
    ...
    VlySkin(
      id: VlySkinId.forest, name: 'Forest', emoji: '🌿',
    ...
    VlySkin(
      id: VlySkinId.crimson, name: 'Crimson', emoji: '🔴',
    ...
    VlySkin(
      id: VlySkinId.sunset, name: 'Sunset', emoji: '🌅',
    ...
    VlySkin(
      id: VlySkinId.violet, name: 'Violet', emoji: '💜',
    ...
    VlySkin(
      id: VlySkinId.rose, name: 'Rose Gold', emoji: '🌸',
    ...
    VlySkin(
      id: VlySkinId.aurora, name: 'Aurora', emoji: '🧊',
    ...
    VlySkin(
      id: VlySkinId.matrix, name: 'Matrix', emoji: '🟩',
    ...
    VlySkin(
      id: VlySkinId.galaxy, name: 'Galaxy', emoji: '✨',
    ...
    // 11. CARBON — гексагоны
    VlySkin(
      id: VlySkinId.carbon, name: 'Carbon', emoji: '⚫',
    ...
    VlySkin(
      id: VlySkinId.sakura, name: 'Sakura', emoji: '🌺',
    ...
    VlySkin(
      id: VlySkinId.gold, name: 'Dark', emoji: '⬛',
  ...
  static VlySkin byId(VlySkinId id) =>
      all.firstWhere((s) => s.id == id, orElse: () => all.first);
}

void _applySkin(VlySkin skin) {
  _accent     = skin.accent;
  _accentBlue = skin.accentSecondary;
}

enum VlyTheme { dark, light, system }